            ...
            <div style="overflow-x: auto;">
                ...
                <thead>
                    <tr style="background-color: #279B48; color: #FFFFFF;">
                        ...
                        <th style="padding: 12px; text-align: center; border-bottom: 4px; font-weight: 400; background-color:rgb(159, 198, 170)"><a href="{{ url('/produkhabis') }}" style="text-decoration: none; color:black">Produk Habis</a></th>
